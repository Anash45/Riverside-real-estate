...
<head>
  ...
  <script src="https://www.google.com/recaptcha/api.js?render=6Lei6_YrAAAAAGNACEv1fARBnxMWm5dm0U1gUGBl"></script>
</head>
  ...
  <main class="pb-5">
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap">
          ...
          <div class="hero-form p-4 bg-white font-work-sans ms-lg-auto mx-auto" id="contact-form">
            ...
            <form method="post" id="contact-form" class="needs-validation" novalidate>
              <div class="mb-4">
                <div class="row gx-3 mb-3">
                  <div class="col">
                    ...
                    <input type="text" class="form-control" name="firstName" required id="firstName" placeholder="Enter first name" />
                  </div>
                  <div class="col">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control"
                    ...
                    required id="phone" name="phone" placeholder="Phone number" />
                </div>

                <div class="mb-3">
                  <label for="investment" class="form-label mb-1">Investment Amount *</label>
                  <input type="number" class="form-control" required id="investment" name="investment" placeholder="Enter amount" />
                </div>
              ...
              <div id="message" class="alert d-none mt-3 mb-0"></div>
            </form>
          </div>
        </div>
      </div>
    ...
    <section class="about-sec position-relative z-1 pb-5">
      <div class="container mb-lg-4">
        <div
          class="d-flex flex-lg-nowrap flex-wrap gap-4 text-md-start text-center justify-content-between mb-5 pb-lg-3">
    ...
    <section class="py-5 my-lg-5 golden-visa-sec">
      <div class="container">
        ...
        <div class="row gx-xl-5 gx-4">
          ...
          <div class="col-lg-6">
            <img src="./assets/images/golden-visa.png" alt="Golden Visa"
              ...
              <div class="row gx-xl-5 gx-4">
                <div class="mb-4 col-md-3 col-sm-6">
                  ...
                  <div class="pt-md-2 d-flex flex-column gap-3">
                    <a href="./index.php" class="f-link lh-1">Home</a>
                    <a href="./index.php#about" class="f-link lh-1">About Riverside</a>
                  </div>
                </div>
      ...
      Array.from(forms).forEach((form) => {
        form.addEventListener("submit", function (event) {
          ...
          if (form.checkValidity()) {
            console.log("✅ Form is valid, preparing reCAPTCHA...");
            ...
            grecaptcha.ready(function () {
              ...
              grecaptcha
                .execute('6Lei6_YrAAAAAGNACEv1fARBnxMWm5dm0U1gUGBl', { action: 'submit' })
                .then(function (token) {
                  ...
                  $.ajax({
                    ...
                    beforeSend: function () {
                      console.log("📤 Sending AJAX request to contact-send.php...");
                      $('#message')
            ...
            `);
                    ...
                    success: function (response) {
                      ...
                      if (response.success) {
                        ...
                        console.warn("⚠️ Server returned validation errors:", response.errors);
                        ...
                        if (Array.isArray(response.errors)) {
                          ...
                          Object.values(response.errors).forEach(errArr => {
                            errorHtml += `<li>${errArr}</li>`;
                          });
                        } else {
                          errorHtml += `<li>${response.message || "Something went wrong."}</li>`;
                        }
                        errorHtml += "</ul>";
                    ...
                    error: function (xhr, status, error) {
                      ...
                      let errorHtml = "<p class='mb-0'>Something went wrong. Please try again.</p>";
                      try {
                        ...
                        console.warn("⚠️ Could not parse error JSON:", e);
                      }
                ...
                .catch(function (err) {
                  ...
                  $('#message')
                    .removeClass('d-none alert-success')
                    .addClass('alert-danger')
                    .text('reCAPTCHA verification failed. Please refresh and try again.');
                });
            });
          } else {
